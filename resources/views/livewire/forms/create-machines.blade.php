<x-form wire:submit="register">
    ...
    <x-choices-offline wire:model="clientId" :options="$clients" placeholder="Search Client ..." single
        option-value="user.id" option-label="user.name" option-sub-label="user.telephone" searchable
